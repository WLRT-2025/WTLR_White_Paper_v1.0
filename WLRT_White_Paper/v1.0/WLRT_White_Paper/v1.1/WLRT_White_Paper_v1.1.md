...
WLRT is proposed as a foundational framework for liquidity-based market analysis, offering potential applications in market microstructure research, risk modeling, and the development of adaptive monitoring systems. This paper presents the core principles, mathematical intuition, and conceptual implications of the theory, serving as a basis for further empirical validation and applied research.
1. Motivation
...
The following sections formalize the theoretical framework introduced above, defining liquidity dynamics, price space, and fundamental quantities necessary for quantitative analysis.
...
\frac{\partial L(p,t)}{\partial t} = - \frac{\partial}{\partial p} \left( v(p,t) L(p,t) \right) + D \frac{\partial^2 L(p,t)}{\partial p^2} + S(p,t)
where:
...
L(P,t): liquidity density


\nabla L: liquidity gradient
...
P(t) = \frac{\int P \, L(P,t) \, dP}{\int L(P,t) \, dP}
...
\frac{d^2 L}{dt^2} + \gamma \frac{d L}{dt} = c^2 \frac{d^2 L}{dP^2} + \frac{dS}{dt}
...
dissipation due to friction and execution costs.


7. Market Regimes
Different classes of solutions correspond to common market regimes:
standing waves → range-bound markets


traveling waves → directional trends


critical damping → flat or inactive markets


impulse responses → news-driven movements
...
system behavior is scale-invariant
...
profit arises from energy loss during oscillations


This is a theoretical interpretation within WLRT; it is not trading advice.
...
Model Formalization and Extensions
...
Farmer, J. D., & Skouras, S. (2013). An Ecological Perspective on the Future of Computer Trading. Foresight, 15(5), 365–374.


Bouchaud, J.-P. (2018). Trades, Quotes and Prices: Financial Markets Under the Microscope. Cambridge University Press.


Eisler, Z., Bouchaud, J.-P., & Kockelkoren, J. (2012). Models for the Impact of All Order Types. Quantitative Finance, 12(9), 1395–1417.


Popov, P. (2025). Wave Liquidity Redistribution Theory (WLRT). Research White Paper, Version 1.0.
17. Disclaimer
